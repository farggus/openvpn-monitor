...
1. **Настройка OpenVPN**
   - Убедитесь, что в конфигурации сервера есть строки:
     ```
...
2. **Структура каталогов**
   #### По умолчанию рекомендуется устанавливать веб-приложение по пути `/var/www`, перейдите по этому пути и склонируйте репозиторий. После клонирования появится каталог `/var/www/openvpn-monitor`. Если желаете установить приложение по другому пути, то:  
